    ...
    describe
        ...
        [ context
              ...
              [ it "runs before each test in the group" (fun () ->
                    ...
                    // Execute the tests
                    nodes |> List.iter (executeNode >> Async.RunSynchronously >> ignore)
                              ...
                              [ beforeEach (fun () -> executionOrder <- executionOrder @ [ "outer" ])
                                ...
                                context
                                    ...
                                    [ beforeEach (fun () -> executionOrder <- executionOrder @ [ "inner" ])
                                      ...
                                      it "test" (fun () -> expect(executionOrder).toEqual ([ "outer"; "inner" ])) ] ] ]
                    ...
                    let nodes =
                        [ describe
                              ...
                              [ afterEach (fun () -> teardownCount <- teardownCount + 1)
                                ...
                                it "test 1" (fun () -> test1Completed <- true)

                                it "test 2" (fun () -> test2Completed <- true) ] ]
                    ...
                    let nodes =
                        [ describe
                              ...
                              [ afterEach (fun () -> teardownRan <- true)
                                ...
                                it "failing test" (fun () -> failwith "test error") ] ]
          ...
          context
              "combined beforeEach and afterEach"
                    ...
                    let nodes =
                        [ describe
                              ...
                              [ beforeEach (fun () -> executionOrder <- executionOrder @ [ "before" ])
                                ...
                                it "test" (fun () -> executionOrder <- executionOrder @ [ "test" ]) ] ]
...
let beforeAllAfterAllSpecs =
    describe
        ...
        [ context
                    ...
                    let nodes =
                        [ describe
                              ...
                              [ afterAll (fun () -> teardownRan <- true)
                                ...
                                it "failing test 1" (fun () -> failwith "error 1")

                                it "failing test 2" (fun () -> failwith "error 2") ] ]
          ...
          context
              "combined beforeAll and afterAll"
              [ it "runs in correct order" (fun () ->
                    let mutable executionOrder = []
                    ...
                    let nodes =
                        [ describe
                              ...
                              [ beforeAll (fun () -> executionOrder <- executionOrder @ [ "beforeAll" ])
                                ...
                                it "test 1" (fun () -> executionOrder <- executionOrder @ [ "test1" ])

                                it "test 2" (fun () -> executionOrder <- executionOrder @ [ "test2" ]) ] ]
          ...
          context
              "mixed with beforeEach/afterEach"
