...
module FX.Spec.Core.Tests.AsyncSupportSpecs
        ...
        [
          ...
          context
              ...
              [ itAsync
                ...
                itAsync
                    "handles async computation expressions"
                    (async {
          ...
          context
              ...
              [ it "creates a FocusedExample node" (fun () ->
                    ...
                    | _ -> failwith "Expected FocusedExample node") ]

          context
              "xitAsync (skipped async tests)"
              [ it "creates a skipped Example node" (fun () ->
                    ...
                    | _ -> failwith "Expected Example node") ]

          context
              "async tests with HTTP scenarios"
              [ itAsync
                ...
                itAsync
                    ...
                    (async {
                        let operations = [ async { return 1 }; async { return 2 }; async { return 3 } ]
          ...
          context
              ...
              [ itAsync
                    "works with async Result workflows"
                    (async {
                        let fetchData () =
                            async {
                                do! Async.Sleep 5
          ...
          context
              ...
              [ it "regular it still works for sync tests" (fun () ->
                ...
                it "can mix sync and async tests" (fun () -> expectBool(true).toBeTrue ()) ] ]
