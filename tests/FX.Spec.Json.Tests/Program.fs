module FX.Spec.Json.Tests.Program

open System
open FX.Spec.Core
open FX.Spec.Json.Tests
...
let main _ =
    ...
    banner
        [ "FX.Spec.Json Test Suite"
          "Core JSON helper specifications"
          "Powered by FX.Spec 🧪" ]

    try
        let suites = [ "JsonHelpers", JsonHelpersSpecs.specs ]
